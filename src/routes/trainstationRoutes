...
router.post('/create',isAuth, isAdmin,fileUpload(`./src/assets/uploads`) ,validateInputCreate, createTrainstation);
router.put('/update',isAuth, isAdmin,fileUpload(`./src/assets/uploads`) , validateInputUpdate, trainstationUpdate);
